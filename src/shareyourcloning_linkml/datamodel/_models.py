...
class OverlapExensionPCRLigationSource(AssemblySource):
    ...
    type: Literal["OverlapExensionPCRLigationSource"] = Field(
        "OverlapExensionPCRLigationSource", description="""The type of the source"""
    )
    output_name: Optional[str] = Field(None, description="""Used to specify the name of the output sequence""")
    id: int = Field(..., description="""A unique identifier for a thing""")
...
class CloningStrategy(ConfiguredBaseModel):
    ...
    sources: List[
        Union[
            ...
            OverlapExensionPCRLigationSource,
...
OverlapExensionPCRLigationSource.model_rebuild()
