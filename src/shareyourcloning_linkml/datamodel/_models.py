...
class UploadedFileSource(Source):
    ...
    circularize: Optional[bool] = Field(
        None, description="""Whether the sequence should be circularized (FASTA only)"""
    )
    input: Optional[List[int]] = Field(
        default_factory=list,
        description="""The sequences that are an input to this source. If the source represents external import of a sequence, it's empty.""",
...
class BenchlingUrlSource(RepositoryIdSource):
    ...
    repository_name: RepositoryName = Field(...)
    repository_id: str = Field(..., description="""The url of the gb file associated with the sequence""")
    input: Optional[List[int]] = Field(
        default_factory=list,
        description="""The sequences that are an input to this source. If the source represents external import of a sequence, it's empty.""",
    )
    ...
    type: Literal["BenchlingUrlSource"] = Field("BenchlingUrlSource", description="""The type of the source""")
    output_name: Optional[str] = Field(None, description="""Used to specify the name of the output sequence""")
    id: int = Field(..., description="""A unique identifier for a thing""")
...
class OverlapExtensionPCRLigationSource(AssemblySource):
    ...
    type: Literal["OverlapExtensionPCRLigationSource"] = Field(
        "OverlapExtensionPCRLigationSource", description="""The type of the source"""
    )
    output_name: Optional[str] = Field(None, description="""Used to specify the name of the output sequence""")
    id: int = Field(..., description="""A unique identifier for a thing""")
...
class GenomeEditingSource(AssemblySource):
    ...
    guides: List[int] = Field(default_factory=list, description="""The guide RNAs used in the CRISPR Genome Editing""")
    circular: Optional[bool] = Field(None, description="""Whether the assembly is circular or not""")
    assembly: List[AssemblyJoin] = Field(
        default_factory=list, description="""The joins between the fragments in the assembly"""
    )
    ...
    type: Literal["GenomeEditingSource"] = Field("GenomeEditingSource", description="""The type of the source""")
    output_name: Optional[str] = Field(None, description="""Used to specify the name of the output sequence""")
    id: int = Field(..., description="""A unique identifier for a thing""")
...
GenomeEditingSource.model_rebuild()
