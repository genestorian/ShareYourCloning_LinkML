...
# Generation date: 2024-08-07T15:49:35
...
class OverlapExensionPCRLigationSourceId(AssemblySourceId):
    pass
...
@dataclass
class OverlapExensionPCRLigationSource(AssemblySource):
    """
    ...
    class_class_uri: ClassVar[URIRef] = SHAREYOURCLONING_LINKML["OverlapExensionPCRLigationSource"]
    class_class_curie: ClassVar[str] = "shareyourcloning_linkml:OverlapExensionPCRLigationSource"
    class_name: ClassVar[str] = "OverlapExensionPCRLigationSource"
    class_model_uri: ClassVar[URIRef] = SHAREYOURCLONING_LINKML.OverlapExensionPCRLigationSource

    id: Union[int, OverlapExensionPCRLigationSourceId] = None
    assembly: Union[Union[dict, AssemblyJoin], List[Union[dict, AssemblyJoin]]] = None

    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        if self._is_empty(self.id):
            self.MissingRequiredField("id")
        if not isinstance(self.id, OverlapExensionPCRLigationSourceId):
            self.id = OverlapExensionPCRLigationSourceId(self.id)
