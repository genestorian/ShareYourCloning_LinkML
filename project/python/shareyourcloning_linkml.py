...
# Generation date: 2024-09-24T17:45:24
...
class GenomeEditingSourceId(AssemblySourceId):
    pass
...
@dataclass
class GenomeEditingSource(AssemblySource):
    """
    Represents the source of a sequence that is generated by Genome Editing
    """

    _inherited_slots: ClassVar[List[str]] = []

    class_class_uri: ClassVar[URIRef] = SHAREYOURCLONING_LINKML["GenomeEditingSource"]
    class_class_curie: ClassVar[str] = "shareyourcloning_linkml:GenomeEditingSource"
    class_name: ClassVar[str] = "GenomeEditingSource"
    class_model_uri: ClassVar[URIRef] = SHAREYOURCLONING_LINKML.GenomeEditingSource

    id: Union[int, GenomeEditingSourceId] = None
    assembly: Union[Union[dict, AssemblyJoin], List[Union[dict, AssemblyJoin]]] = None
    guides: Union[Union[int, PrimerId], List[Union[int, PrimerId]]] = None
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        if self._is_empty(self.id):
            self.MissingRequiredField("id")
        if not isinstance(self.id, GenomeEditingSourceId):
            self.id = GenomeEditingSourceId(self.id)
...
slots.genomeEditingSource__guides = Slot(
    uri=SHAREYOURCLONING_LINKML.guides,
    name="genomeEditingSource__guides",
    curie=SHAREYOURCLONING_LINKML.curie("guides"),
    model_uri=SHAREYOURCLONING_LINKML.genomeEditingSource__guides,
    domain=None,
    range=Union[Union[int, PrimerId], List[Union[int, PrimerId]]],
)
