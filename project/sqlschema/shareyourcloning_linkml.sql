...
--     * Slot: GenomeEditingSource_id Description: Autocreated FK slot
...
--     * Slot: output_name Description: Used to specify the name of the output sequence
--     * Slot: id Description: A unique identifier for a thing
-- # Class: "GenomeEditingSource" Description: "Represents the source of a sequence that is generated by Genome Editing"
--     * Slot: circular Description: Whether the assembly is circular or not
--     * Slot: output Description: Identifier of the sequence that is the output of this source.
--     * Slot: type Description: The type of the source
--     * Slot: output_name Description: Used to specify the name of the output sequence
...
--     * Slot: CRISPRSource_id Description: Autocreated FK slot
--     * Slot: input_id Description: The sequences that are an input to this source. If the source represents external import of a sequence, it's empty.
-- # Class: "GenomeEditingSource_guides" Description: ""
--     * Slot: GenomeEditingSource_id Description: Autocreated FK slot
--     * Slot: guides_id Description: The guide RNAs used in the CRISPR Genome Editing
-- # Class: "GenomeEditingSource_input" Description: ""
--     * Slot: GenomeEditingSource_id Description: Autocreated FK slot
--     * Slot: input_id Description: The sequences that are an input to this source. If the source represents external import of a sequence, it's empty.
...
CREATE TABLE "GenomeEditingSource" (
	circular BOOLEAN,
	output INTEGER,
	type TEXT,
	output_name TEXT,
...
CREATE TABLE "AssemblyJoin" (
	...
	"GenomeEditingSource_id" INTEGER,
	...
	FOREIGN KEY("GenomeEditingSource_id") REFERENCES "GenomeEditingSource" (id),
...
CREATE TABLE "GenomeEditingSource_guides" (
	"GenomeEditingSource_id" INTEGER,
	guides_id INTEGER NOT NULL,
	PRIMARY KEY ("GenomeEditingSource_id", guides_id),
	FOREIGN KEY("GenomeEditingSource_id") REFERENCES "GenomeEditingSource" (id),
	FOREIGN KEY(guides_id) REFERENCES "Primer" (id)
);
CREATE TABLE "GenomeEditingSource_input" (
	"GenomeEditingSource_id" INTEGER,
	input_id INTEGER,
	PRIMARY KEY ("GenomeEditingSource_id", input_id),
	FOREIGN KEY("GenomeEditingSource_id") REFERENCES "GenomeEditingSource" (id),
	FOREIGN KEY(input_id) REFERENCES "Sequence" (id)
);
