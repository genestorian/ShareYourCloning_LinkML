...
--     * Slot: OverlapExensionPCRLigationSource_id Description: Autocreated FK slot
...
--     * Slot: output_name Description: Used to specify the name of the output sequence
--     * Slot: id Description: A unique identifier for a thing
-- # Class: "OverlapExensionPCRLigationSource" Description: "Represents the source of a sequence that is generated by ligation of PCR products as part of overlap extension PCR. Algorithmically equivalent to Gibson assembly."
--     * Slot: circular Description: Whether the assembly is circular or not
--     * Slot: output Description: Identifier of the sequence that is the output of this source.
--     * Slot: type Description: The type of the source
--     * Slot: output_name Description: Used to specify the name of the output sequence
...
--     * Slot: GibsonAssemblySource_id Description: Autocreated FK slot
--     * Slot: input_id Description: The sequences that are an input to this source. If the source represents external import of a sequence, it's empty.
-- # Class: "OverlapExensionPCRLigationSource_input" Description: ""
--     * Slot: OverlapExensionPCRLigationSource_id Description: Autocreated FK slot
--     * Slot: input_id Description: The sequences that are an input to this source. If the source represents external import of a sequence, it's empty.
...
CREATE TABLE "OverlapExensionPCRLigationSource" (
	circular BOOLEAN,
	output INTEGER,
	type TEXT,
	output_name TEXT,
...
CREATE TABLE "AssemblyJoin" (
	...
	"OverlapExensionPCRLigationSource_id" INTEGER,
	...
	FOREIGN KEY("OverlapExensionPCRLigationSource_id") REFERENCES "OverlapExensionPCRLigationSource" (id),
...
CREATE TABLE "OverlapExensionPCRLigationSource_input" (
	"OverlapExensionPCRLigationSource_id" INTEGER,
	input_id INTEGER,
	PRIMARY KEY ("OverlapExensionPCRLigationSource_id", input_id),
	FOREIGN KEY("OverlapExensionPCRLigationSource_id") REFERENCES "OverlapExensionPCRLigationSource" (id),
	FOREIGN KEY(input_id) REFERENCES "Sequence" (id)
);
