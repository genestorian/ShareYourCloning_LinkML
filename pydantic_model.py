...
class Sequence(NamedThing):
    ...
    type: Literal["Sequence"] = Field(
        "Sequence", description="""The type of the source"""
    )
...
class TextFileSequence(Sequence):
    ...
    type: Literal["TextFileSequence"] = Field(
        "TextFileSequence", description="""The type of the source"""
    )
...
class Primer(Sequence):
    ...
    name: Optional[str] = Field(
        None, description="""A human-readable name for a thing"""
    )
...
class ManuallyTypedSource(Source):
    ...
    circular: Optional[bool] = Field(
        None, description="""Whether the sequence is circular or not"""
    )
    input: Optional[List[int]] = Field(
        default_factory=list,
        description="""The sequences that are an input to this source. If the source represents external import of a sequence, it's empty.""",
    ...
    type: Literal["ManuallyTypedSource"] = Field(
        "ManuallyTypedSource", description="""The type of the source"""
    )
    id: int = Field(..., description="""A unique identifier for a thing""")
...
class UploadedFileSource(Source):
    ...
    index_in_file: Optional[int] = Field(
        None, description="""The index of the sequence in the file"""
    )
    input: Optional[List[int]] = Field(
        default_factory=list,
        description="""The sequences that are an input to this source. If the source represents external import of a sequence, it's empty.""",
    ...
    type: Literal["UploadedFileSource"] = Field(
        "UploadedFileSource", description="""The type of the source"""
    )
    id: int = Field(..., description="""A unique identifier for a thing""")
...
class RepositoryIdSource(Source):
    ...
    type: Literal["RepositoryIdSource"] = Field(
        "RepositoryIdSource", description="""The type of the source"""
    )
    id: int = Field(..., description="""A unique identifier for a thing""")
...
class SequenceCutSource(Source):
    ...
    type: Literal["SequenceCutSource"] = Field(
        "SequenceCutSource", description="""The type of the source"""
    )
    id: int = Field(..., description="""A unique identifier for a thing""")
...
class SimpleSequenceLocation(ConfiguredBaseModel):
    ...
    strand: Optional[int] = Field(
        None, description="""The strand of the location, should be 1 or -1 or null"""
    )
...
class AssemblySource(Source):
    ...
    circular: Optional[bool] = Field(
        None, description="""Whether the assembly is circular or not"""
    )
    ...
    type: Literal["AssemblySource"] = Field(
        "AssemblySource", description="""The type of the source"""
    )
    id: int = Field(..., description="""A unique identifier for a thing""")
...
class PCRSource(AssemblySource):
    ...
    forward_primer: int = Field(
        ..., description="""The forward primer used in the PCR"""
    )
    reverse_primer: int = Field(
        ..., description="""The reverse primer used in the PCR"""
    )
    circular: Optional[bool] = Field(
        None, description="""Whether the assembly is circular or not"""
    )
    ...
    type: Literal["PCRSource"] = Field(
        "PCRSource", description="""The type of the source"""
    )
    id: int = Field(..., description="""A unique identifier for a thing""")
...
class LigationSource(AssemblySource):
    ...
    type: Literal["LigationSource"] = Field(
        "LigationSource", description="""The type of the source"""
    )
    id: int = Field(..., description="""A unique identifier for a thing""")
...
class GibsonAssemblySource(AssemblySource):
    ...
    type: Literal["GibsonAssemblySource"] = Field(
        "GibsonAssemblySource", description="""The type of the source"""
    )
    id: int = Field(..., description="""A unique identifier for a thing""")
...
class CloningStrategy(ConfiguredBaseModel):
    ...
    description: Optional[str] = Field(
        None, description="""A description of the cloning strategy"""
    )
